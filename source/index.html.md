...
| taker_pubkey      | Public key of the user account for which the order is being placed         | No       |
| signing_authority | Public key of the signing authority (delegate) that signs the order message | No       |
